export class TestDatabase {
    ...
    constructor(params?: {totalSpentOnShares?: number, totalNumberOfSharesDistributed: number}) {
        this.totalSpentOnShares = params?.totalSpentOnShares || 200
        this.totalNumberOfSharesDistributed = params?.totalNumberOfSharesDistributed || 2
    }
